...
@fixture
def no_env_vars(monkeypatch: MonkeyPatch) -> None:
...
@fixture
def env_vars_simple(monkeypatch: MonkeyPatch) -> None:
...
@fixture
def env_vars_with_special_symbols(monkeypatch: MonkeyPatch) -> None:
    monkeypatch.setenv("SPRUT_MONGODB_HOSTNAME", "hostname-simple")
